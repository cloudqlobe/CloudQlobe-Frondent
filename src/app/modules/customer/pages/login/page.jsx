...
const Login = () => {
  ...
  const handleSignUp = () => {
    history.push('/modules/customer/pages/signup_one'); // Navigate to the sign-up page
  };

  // Function to navigate to Forgot Password page
  const handlePassword = () => {
    history.push('/modules/customer/pages/forgotPassword/SendEmail'); // Navigate to Forgot Password page
  };
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await axiosInstance.post("api/customers/login", { username: email, password }); // Adjust the API URL accordingly
      ...
      history.push("/modules/customer/pages/dash_layout");
    } catch (error) {
