...
const NormalRatesPage = () => {
  ...
  const countryOptions = Array.from(
    new Set(normalRatesData.map((item) => item.country))
  ).sort();
      ...
      <div className="p-0 bg-gray-100 text-gray-800">
        ...
        <div className="flex items-center" style={{ marginLeft: "0em" }}>
          ...
          <div className="flex items-center p-2 py-2 rounded-lg bg-blue-500">
            <h1 className="text-lg font-regular text-white mb-0">
              Premium CLI Routes
            </h1>
          </div>
        </div>
          ...
          <table className="rateTable w-full font-normal border-collapse bg-white shadow-lg rounded-lg">
            <thead>
              <tr className="bg-[#005F73] text-white font-normal uppercase rounded-lg">
                {showSelectColumn && (
                  <th className="p-2 text-center border rounded-lg border-gray-300">
                    Select
                  </th>
                )}
                ...
                <th className="p-2 text-center border border-gray-300 w-1/4">
                  Quality Description
                </th>
                  ...
                  {showSelectColumn && (
                    <td className="p-2 text-center border border-gray-300">
                      <input
                        ...
                        onChange={() => {
                          if (
                            selectedRates.some((rate) => rate._id === item._id)
                          ) {
                            setSelectedRates(
