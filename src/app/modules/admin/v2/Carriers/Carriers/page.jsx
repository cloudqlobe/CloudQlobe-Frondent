...
const CustomersPage = () => {
  ...
  const handleRowClick = (customerId) => navigate(`/admin/carrier/carrier/${customerId}`);
        ...
        <div>
          ...
          >
            ...
            <button className="flex items-center bg-green-500 text-white px-4 py-2  hover:bg-green-600 text-sm">
              ...
              <Link to="/admin/carrier/customer/addlead"><span className="text-sm">ADD LEAD</span></Link>
            </button>
